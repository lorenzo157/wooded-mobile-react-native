...
export default function TiltMeasure({ onTiltChange, children }: TiltMeasureProps) {
  ...
  return (
    <View style={styles.card}>
      ...
      <Text style={styles.hint}>Apoye el celular contra el tronco del arbol</Text>
      <View style={styles.buttonRow}>
        <TouchableOpacity
          style={[styles.startButton, (!canStart || isMeasuring) && styles.buttonDisabled]}
          onPress={start}
